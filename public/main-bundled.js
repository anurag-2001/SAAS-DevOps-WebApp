    ...
    e.exports = (function () {
      ...
      return (function e() {
        ...
        var Z = y,
          ...
          ke = p({}, ["audio", "video", "img", "source", "image"]),
          Re = null,
          Oe = p({}, [
            "alt",
            "class",
          ...
          Ce = function (e) {
            (Me && Me === e) ||
              ...
              (Re = "ADD_URI_SAFE_ATTR" in e ? p({}, e.ADD_URI_SAFE_ATTR) : Oe),
              ...
              Ae &&
                ((oe = p({}, [].concat(A(o)))),
                (se = []),
                !0 === Ae.html && (p(oe, t), p(se, s)),
                !0 === Ae.svg && (p(oe, r), p(se, c), p(se, l)),
                !0 === Ae.svgFilters && (p(oe, n), p(se, c), p(se, l)),
                !0 === Ae.mathMl && (p(oe, i), p(se, u), p(se, l))),
              e.ADD_TAGS && (oe === ae && (oe = m(oe)), p(oe, e.ADD_TAGS)),
              e.ADD_ATTR && (se === ce && (se = m(se)), p(se, e.ADD_ATTR)),
              e.ADD_URI_SAFE_ATTR && p(Re, e.ADD_URI_SAFE_ATTR),
              Se && (oe["#text"] = !0),
          ...
          He = function (e) {
            ...
            if ((v && p(ue, ["title"]), !t || !t.documentElement)) {
              var i = (t = G.createHTMLDocument("")),
                o = i.body;
              o.parentNode.removeChild(o.parentNode.firstElementChild),
                (o.outerHTML = B ? B.createHTML(e) : e);
            }
            return (
              r &&
                t.body.insertBefore(
        ...
        f.isSupported &&
          ((function () {
            try {
              ...
              e.querySelector("svg img") && (h = !0);
            } catch (e) {}
          })(),
          (function () {
            try {
              var e = He("<x/><title>&lt;/title&gt;&lt;img&gt;");
              e.querySelector("title").innerHTML.match(/<\/title/) && (v = !0);
            } catch (e) {}
          })());
        var je = function (e) {
            return Y.call(
          ...
          Fe = function (e) {
            return "object" === (void 0 === _ ? "undefined" : L(_))
              ? e instanceof _
              : e &&
                  "object" === (void 0 === e ? "undefined" : L(e)) &&
          ...
          Ue = function (e) {
            var t,
              r = void 0;
            if (
              (qe("beforeSanitizeElements", e, null),
              !(
                (t = e) instanceof q ||
                t instanceof U ||
            ...
            if (
              (qe("uponSanitizeElement", e, { tagName: n, allowedTags: oe }),
              !oe[n] || ue[n])
            ) {
              if (Se && !Ee[n] && "function" == typeof e.insertAdjacentHTML)
                try {
                  var i = e.innerHTML;
              ...
              : (!pe ||
                ...
                me &&
                  ...
                  e.textContent !== r &&
                    (f.removed.push({ element: e.cloneNode() }),
                    (e.textContent = r))),
                qe("afterSanitizeElements", e, null),
                !1);
          },
          Ie = function (e, t, r) {
            if (xe && ("id" === t || "name" === t) && (r in D || r in De))
              return !1;
            if (de && ee.test(t));
          ...
          ze = function e(t) {
            var r = void 0,
              n = je(t);
            for (qe("beforeSanitizeShadowDOM", t, null); (r = n.nextNode()); )
              qe("uponSanitizeShadowNode", r, null),
                Ue(r) || (r.content instanceof C && e(r.content), Pe(r));
        ...
        return (
          (f.sanitize = function (e, t) {
            ...
            if ((ye || Ce(t), (f.removed = []), Le));
            else if (e instanceof _)
              (r = He("\x3c!--\x3e")),
                1 === (n = r.ownerDocument.importNode(e, !0)).nodeType &&
                "BODY" === n.nodeName
                  ? (r = n)
                  : "HTML" === n.nodeName
                  ? (r = n)
              ...
              if (!be && !me && !ve && -1 === e.indexOf("<"))
                return B ? B.createHTML(e) : e;
              if (!(r = He(e))) return be ? null : V;
            }
            r && ge && Ne(r.firstChild);
            for (var c = je(Le ? e : r); (i = c.nextNode()); )
              (3 === i.nodeType && i === o) ||
                Ue(i) ||
                (i.content instanceof C && ze(i.content), Pe(i), (o = i));
            if (((o = null), Le)) return e;
            if (be) {
              if (we)
